...
# Attempt to print outline of brot. Outline of Sea Horse valley.
...
offset     = 0.0001
maxiter    = 42
# Detail gets fainter for large maxiter.
calc_count = 0
rnum       = 3
...
fname = 'Outline_Brot_' + str( offset ) + '.png'
